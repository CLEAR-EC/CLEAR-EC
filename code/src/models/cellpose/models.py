        ...
        if do_3D:
            ...
            if resample:
                ...
                dP = transforms.resize_image(
                    dP.transpose(1, 2, 3, 0), Ly=Ly_0, Lx=Lx_0, no_channels=False
                )
                dP = transforms.resize_image(
                    dP.transpose(1, 0, 2, 3), Lx=Lx_0, Ly=Lz_0, no_channels=False
                )
                ...
                cellprob = transforms.resize_image(
                    cellprob.transpose(1, 0, 2), Lx=Lx_0, Ly=Lz_0, no_channels=True
                )
