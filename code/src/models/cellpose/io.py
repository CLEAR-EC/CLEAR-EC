...
def load_images_and_paths_labels(
...
def load_train_test_data(
    ...
    """
    images, labels, image_names = load_images_and_paths_labels(
        train_dir, mask_filter, image_filter, look_one_level_down
    )
    # testing data
    test_images, test_labels, test_image_names = None, None, None
    if test_dir is not None:
        test_images, test_labels, test_image_names = load_images_and_paths_labels(
